...
-- AddForeignKey
ALTER TABLE `users_perfils` ADD CONSTRAINT `users_perfils_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `users_perfils` ADD CONSTRAINT `users_perfils_perfil_id_fkey` FOREIGN KEY (`perfil_id`) REFERENCES `perfils`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
